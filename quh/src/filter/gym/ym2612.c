...
** Version 0.36c
**
** Modified by Marp (marp@technologist.com) to better suit YMAMP.
*/
...
//                if(isbitset(&channels, 8))
                    FM_CALC_CH(cch[0]);
//                if(isbitset(&channels, 9))
                    FM_CALC_CH(cch[1]);
//                if(isbitset(&channels, 10))
                    FM_CALC_CH(cch[2]);
//                if(isbitset(&channels, 11))
                    FM_CALC_CH(cch[3]);
//                if(isbitset(&channels, 12))
                    FM_CALC_CH(cch[4]);
//                if(isbitset(&channels, 13)) {
                    if(dacen)
